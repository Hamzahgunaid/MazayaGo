...
const MazayaGoUnifiedHomepage = () => {
  ...
  const services = [
    {
      ...
      descCompetitor: 'اشترِ وادخل السحب - فرصتك للفوز بجوائز قيّمة مع سحوبات شفافة ونتائج فورية',
  ...
  const useCasesOrganizers = [
    { icon: IndustryIcons.restaurants, title: 'المطاعم والمقاهي', service: 'السحوبات', desc: 'سحوبات "اشترِ وادخل السحب" لزيادة المبيعات' },
  ...
  const useCasesCompetitors = [
    ...
    { icon: UserTypeIcons.luckHunter, title: 'صياد الحظ', service: 'السحوبات', desc: 'شارك في سحوبات يومية مجانية واربح' },
    ...
    <nav style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '32px', alignItems: 'center' }}>
          {['الرئيسية', 'الخدمات', 'كيف تعمل'].map((item) => (
      ...
      <div style={{
        ...
        <div style={{ 
          ...
          <p style={{
            ...
            {isOrganizer 
              ? 'أطلق حملاتك الرمضانية مجاناً - سحوبات شفافة، ألغاز تفاعلية، وتوقعات مثيرة تجذب جمهورك!'
          ...
          <p style={{
            ...
            {isOrganizer ? '✨ ابدأ مجاناً بدون أي تكلفة' : '✨ سحوبات، ألغاز، وتوقعات'}
          </p>
          ...
          <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
            <button style={{
              ...
              {isOrganizer ? 'أنشئ حملتك الآن' : 'ابدأ الآن'}
            </button>
            <button style={{
              padding: '18px 40px',
              fontSize: '18px',
              ...
              {isOrganizer ? 'شاهد كيف تعمل' : 'تعرف أكثر'}
            </button>
          </div>
        </div>
  ...
  const HowItWorksSection = () => (
    <section id="كيف تعمل" style={{ 
      padding: '100px 24px', 
      backgroundColor: isOrganizer ? colors.white : colors.light,
    }}>
      <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
        ...
        <div style={{ 
          ...
          <div style={{
            ...
            right: '15%',
            height: '3px',
            background: `linear-gradient(90deg, ${colors.teal}, ${colors.orange}, ${colors.teal}, ${colors.green})`,
            borderRadius: '2px',
            zIndex: 0,
          }} />
    ...
    <section style={{
      ...
      <div style={{ maxWidth: '700px', margin: '0 auto' }}>
        ...
        <p style={{ 
          ...
          {isOrganizer 
            ? 'أنشئ حملتك الأولى مجاناً وابدأ في جذب جمهورك'
            : 'سجّل الآن وابدأ المنافسة على جوائز رمضان'}
        </p>
        <button style={{
          padding: '20px 56px',
          fontSize: '22px',
